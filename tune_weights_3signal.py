...
def score(row, w):
    # llm and retrieval fixed at 0 — both zeroed out in two independent
    # tuning runs, treated as uninformative rather than re-searched.
    return (w["history"]*row["s_history"] + w["logs"]*row["s_logs"] +
