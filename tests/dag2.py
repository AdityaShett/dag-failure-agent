...
def validate_schema(**context):
    ...
    with open(path, 'rb') as original_f:
        content = original_f.read()
    with open(validated_path, 'wb') as validated_f:
        validated_f.write(content)
    print(f"Schema validated and copied to {validated_path}")
