...
# Use an accessible GCS bucket for report storage.
REPORT_BUCKET = "gs://your-accessible-project-bucket/"

def extract_reporting_data(**context):    context["ti"].xcom_push(key="report_path", value="/tmp/report_2026_08_30.csv")
