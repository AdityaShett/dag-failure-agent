...
# Fix: Changed to a placeholder bucket where the DAG's service account is presumed to have `storage.objectCreator` permissions.
REPORT_BUCKET = "gs://your-airflow-project-data/"
