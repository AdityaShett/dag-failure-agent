...
with DAG("dag6", start_date=datetime(2026, 1, 1), schedule=None, catchup=False) as dag:
    ...
    # The task 'run_batch_job' was identified in logs as failing but was not defined in the DAG.
    # This adds the missing task, assuming it was intended to execute the 'call_partner_api' function
    # given the context and available functions.
